  ...
  {"enable_partition",
   {offsetof(struct DeltaOptions, enable_partition), OptionType::kBoolean,
    ...
    {"gdct_log_compact_size",
     {offsetof(struct DeltaOptions, gdct_log_compact_size), OptionType::kUInt64T,
      OptionVerificationType::kDeprecated, OptionTypeFlags::kMutable}},
    ...
    {"compaction_l0_files_to_pick",
     {offsetof(struct DeltaOptions, compaction_l0_files_to_pick), OptionType::kSizeT,
      OptionVerificationType::kDeprecated, OptionTypeFlags::kMutable}},
    {"max_delta_threads",
     {offsetof(struct DeltaOptions, max_delta_threads), OptionType::kInt,
      OptionVerificationType::kDeprecated, OptionTypeFlags::kMutable}},
    {"sharding_count",
     {offsetof(struct DeltaOptions, sharding_count), OptionType::kUInt32T,
      OptionVerificationType::kDeprecated, OptionTypeFlags::kMutable}},
};
